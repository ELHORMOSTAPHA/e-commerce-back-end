    ...
    <form action="" class="kt-card-content flex flex-col gap-5 p-10" id="sign_in_form" method="post">
     ...
     <div class="grid grid-cols-2 gap-2.5">
      <a class="kt-btn kt-btn-outline justify-center" href="#">
       <img alt="" class="size-3.5 shrink-0" src="<?= base_url()?>/public/assets/media/brand-logos/google.svg"/>
       Use Google
      </a>
      <a class="kt-btn kt-btn-outline justify-center" href="#">
       <img alt="" class="size-3.5 shrink-0 dark:hidden" src="<?= base_url()?>/public/assets/media/brand-logos/apple-black.svg"/>
       <img alt="" class="size-3.5 shrink-0 light:hidden" src="<?= base_url()?>/public/assets/media/brand-logos/apple-white.svg"/>
       Use Apple
      </a>
     </div>
